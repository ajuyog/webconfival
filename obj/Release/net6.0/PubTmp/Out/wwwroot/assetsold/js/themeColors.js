...
function localStorageBackup() {
    ...
    if (localStorage.darkBackgroundColor) {
        document.getElementById('transparentBgColorID').value = localStorage.darkBackgroundColor;
        document.querySelector('html').style.setProperty('--dark-body', localStorage.darkBackgroundColor);
    ...
    if (localStorage.BgImage) {
        document.querySelector('body')?.classList.add('dark-mode');
        let bgImg = localStorage.BgImage;
...
function transparentBgColor() {
    ...
    localStorage.setItem('darkBackgroundColor', userColor);
